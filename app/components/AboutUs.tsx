            ...
            <div className='max-w-7xl mx-auto px-4 py-24'>
                <div className='flex items-center justify-between'>
                    <div>
                        ...
                        <h2 className='text-white text-[60px] font-bold my-4'>Biz haqimizda</h2>
                        <p className='text-[18px] text-gray-300 max-w-xl'>"Mrrochi" kompaniyasi ko'p yillardan buyon bozorda o'z o'rniga ega bo'lgan,
