...
const HeroSection: React.FC = () => {
  ...
  const slideDuration = slides.length * 5;
    ...
    <header className="relative w-full overflow-hidden max-md:pb-12 h-screen">
      <div className="absolute inset-0 -z-10">
        {slides.map((img, index) => (
          <div
            key={img}
            className="hero-bg-slide absolute inset-0 h-screen w-full bg-cover bg-center max-md:h-full max-md:bg-fixed"
            style={{
          ...
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl font-bold leading-tight text-white sm:text-5xl md:text-6xl">
              <Trans
                ...
                components={{
                  highlight: <span className="text-gray-400" />,
                  br: <br />,
                }}
              />
            </h1>
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <a
                ...
                aria-label="Grand Window katalogini yuklab olish"
